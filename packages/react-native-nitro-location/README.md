...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/nitro_location/`](android/src/main/java/com/margelo/nitro/nitro_location/): All Kotlin implementations.
    - [`NitroLocationPackage.java`](android/src/main/java/com/margelo/nitro/nitro_location/NitroLocationPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
